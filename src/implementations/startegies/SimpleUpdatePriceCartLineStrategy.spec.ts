...
import { SimpleUpdatePriceCartLineStrategy } from "./SimpleUpdatePriceCartLineStrategy";
import { CartLineFactory } from "../factories/CartLineFactory";
import { CartLine } from "../CartLine";
import { ICartItem } from "../../interfaces/ICartItem";

describe("SimpleUpdatePriceCartLineStrategy", () => {
  let strategy: SimpleUpdatePriceCartLineStrategy;
  ...
  beforeEach(function() {
    ...
    strategy = new SimpleUpdatePriceCartLineStrategy(cartLineFactory);
  });
